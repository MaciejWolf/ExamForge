...
**Description:** A comprehensive screen for creating or editing a test template. This is where examiners manage **local pools** specific to this template. The page includes:

#### Template Basic Info Section
- Template name input
- Template description (optional)

#### Local Pools Management Section
**Description:** Displays all pools created within this template. For each pool:
- Pool name (must be unique within the template)
- Number of questions assigned to this pool
- Number of questions to randomly draw from this pool
- Actions: Edit pool, Delete pool

**Pool Management Features:**
- Create new pool (modal/inline form with pool name)
- Delete pool (questions become unassigned in this template context)
- Edit pool name
- Validation: Cannot save template if draw count > available questions in any pool
...
- Ability to move a question from one pool to another (removes from first, adds to second)
