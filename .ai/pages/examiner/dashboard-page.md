...
-   **Action:** An examiner clicks the "Question Bank" navigation card/button.
-   **Destination:** The Question Bank List Page.
...
-   **Question Bank Card:** A clickable card/button that navigates to the Question Bank List Page. Includes an icon, title, and descriptive text explaining its purpose.
...
-   This is the main entry point for all examiner-specific functionality mentioned in the PRD:
    -   Question Bank Management (`US-004`)
    -   Test Templates Management (`US-005`, `US-006`)
