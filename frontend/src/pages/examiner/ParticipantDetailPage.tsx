...
export const ParticipantDetailPage = () => {
  ...
  const timeLimitMinutes = 60; // TODO: Pass this from navigation state or fetch from session
    ...
    return (
      <DashboardLayout>
        <div className="flex items-center justify-center min-h-[400px]">
          <p className="text-muted-foreground">Invalid participant or session ID</p>
        </div>
      </DashboardLayout>
    );
  }
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        {/* Back Button */}
        <Button variant="ghost" size="sm" onClick={() => navigate(`/test-sessions/${sessionId}/report`)}>
        ...
        {/* Question Breakdown */}
        {!isNotStarted && detail.questions.length > 0 && (
          <Card>
            <CardHeader>
